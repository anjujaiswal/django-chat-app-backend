...
import datetime
from common.constants import Constants, ErrMsg, ErrMsgCode
...
class AddGroup(APIView):
    ...
    def post(self, request):
        try:
            ...
            if room_type == "individual" or room_type == "group":
               pass
            else:
    ...
    def patch(self, request):
        try:
            ...
            if token_group_member_obj.is_admin == "off":
                return error_response(success=False,
                                     status_code = status.HTTP_403_FORBIDDEN,
                                     message=Constants.YOU_ARE_NOT_ADMIN,
            ...
            try:
                ...
                return error_response(success=False,
                                     status_code= status.HTTP_400_BAD_REQUEST,
                                     message= Constants.UNABLE_TO_MAKE_ADMIN,
    ...
    def patch(self,request):
        try:
            ...
            try:
                ...
                return error_response(success=False,
                                     status_code=status.HTTP_403_FORBIDDEN,
                                     message= Constants.UNABLE_TO_LEAVE_GROUP,
                                     error_msg=ErrMsg.YOU_ARE_NOT_PRESENT_IN_THE_GROUP,
                                     message_code=ErrMsgCode.FORBIDDEN)
...
class GroupMembersApi(APIView):
    ...
    def get(self, request):
        ...
        try:
            ...
            serializer_groupmember  = GroupMembersgettingSerializer(member_objs, many = True)
            return json_response(success=True,
                                 status_code=status.HTTP_200_OK,
